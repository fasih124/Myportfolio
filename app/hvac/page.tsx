...
export const metadata: Metadata = {
  title: "HVAC Lead Generation Websites for UK Engineers | 10-Day Build",
  description:
    "Websites built specifically for Gas Safe heating engineers. 98/100 PageSpeed. 10-day fixed delivery. Fixed price. No monthly fee. You own it permanently.",
  openGraph: {
    title: "The 10-Day HVAC Lead Engine",
    description:
      "Stop renting leads from Checkatrade. Own the channel that brings them — permanently.",
    type: "website",
  },
};
